...
start_txt = (
    f"{e(_E_STAR,'🌟')} {e(_E_GLOW,'🤩')} <b>𝐌ɪᴋᴀsᴀ ꭙ 𝐌ᴜꜱɪᴄ ♪˼✨ | 𝛅 ᥲ s 𝛖 𝛋 ᴇ ࿐</b> {e(_E_GLOW,'🤩')} {e(_E_STAR,'🌟')}\n\n"
    ...
    f"{e(_E_ROSE,'🌹')} ᴘᴏᴡєʀєᴅ ʙʏ» <a href=\"https://t.me/sasuke_qt\">ටිαѕυкє</a>\n"
...
async def start(_, msg):
    ...
    await msg.reply_photo(
        photo="https://files.catbox.moe/yurtlv.jpg",
        caption=start_txt,
